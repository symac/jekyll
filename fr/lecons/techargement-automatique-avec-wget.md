---
title: Téléchargement automatique avec wget
layout: lesson
date: 2012-06-27
authors:
- Ian Milligan
...
activity: acquiring
topics: [web-scraping]
abstract: "Wget est un programme qui s'utilise en ligne de commande et peut être très utile pour télécharger des contenus disponibles en ligne."
next: applied-archival-downloading-with-wget
redirect_from: /fr/lessons/automated-downloading-with-wget
---
...
Cette leçon implique l'utilisation de la ligne de commande. Si vous
n'avez jamais utilisé ce type d'outils par le passé, nous vous conseillons
la lecture de l'[Introduction au lanage Bash](bash-introduction).
